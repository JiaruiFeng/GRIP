...
def process_cwq(save_dir: str):
    make_dir(save_dir)
    train_dataset = load_dataset("rmanluo/RoG-cwq", split="train")
    val_dataset = load_dataset("rmanluo/RoG-cwq", split="validation")
    test_dataset = load_dataset("rmanluo/RoG-cwq", split="test")
